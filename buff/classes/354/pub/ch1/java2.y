/*
  https://opensource.apple.com/source/llvmgcc42/llvmgcc42-2118/gcc/java/parse-scan.y
*/

/* Parser grammar for quick source code scan of Java(TM) language programs.
   Copyright (C) 1998, 1999, 2000, 2002, 2003, 2004, 2005
   Free Software Foundation, Inc.
   Contributed by Alexandre Petit-Bianco (apbianco@cygnus.com <mailto:apbianco@cygnus.com>)
