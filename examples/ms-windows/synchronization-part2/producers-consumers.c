...
/* To make the console stay open when the program exits in VS 2013,
 * Right-click on your project in Visual Studio > Properties > Configuration
 * Properties > Linker > System, change Subsystem to "Console" 
 */
